...
![KoboToolbox](https://img.shields.io/badge/KoboToolbox-2C3E50?style=for-the-badge&logo=databricks&logoColor=white)
...
![Inteligencia Artificial](https://img.shields.io/badge/Inteligencia_Artificial-8B5CF6?style=for-the-badge&logo=openai&logoColor=white)
![IA Devs](https://img.shields.io/badge/IA_Devs-6D28D9?style=for-the-badge&logo=anthropic&logoColor=white)
...
|----------|-------------|-------------|
| | 📱 **Senda Vida** | App móvil GPS para ciclistas y senderistas con IA integrada | React Native · Spring Boot · PostgreSQL |
| 🧹 **CSV SQL Cleaner** | Herramienta de limpieza de datos con GUI, exportación Excel y T-SQL | Python · openpyxl · SQL |
| 📊 **Dashboard Ventas** | Dashboard interactivo de ventas con Power BI  | Power BI · Python · Excel  |
