...
| 🧹 **CSV SQL Cleaner** | Herramienta de limpieza de datos con GUI, exportación Excel y T-SQL | Python · Tkinter · openpyxl · SQL |
| 📊 **Dashboard Ventas** | Dashboard interactivo de ventas con Power BI y Looker Studio | Power BI · Python · Excel · Looker Studio |
